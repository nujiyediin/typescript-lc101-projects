...
// console.log(`${spacecraftName} will take ${daysToMars} days to travel to Mars.`);
...
// console.log(`${spacecraftName} will take ${getDaysToLocation(kilometersToMars)} days to travel to Mars`);
// console.log(`${spacecraftName} will take ${getDaysToLocation(kilometersToTheMoon)} days to travel to the moon.}`);
